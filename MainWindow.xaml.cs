...
public partial class MainWindow : Window
{
    ...
    private async void Ok_Click(object sender, RoutedEventArgs e)
    {
        ...
        SixteenPlayerLobbyButton.Visibility = Visibility.Collapsed;
    }

    private async void SixteenPlayerLobby_Click(object sender, RoutedEventArgs e)
    {
        SixteenPlayerLobbyButton.IsEnabled = false;
        SixteenPlayerLobbyButton.Content = "enabling lobbies...";
        SetStatus("Attaching to STRAFTAT.exe...");

        var enabled = await _backend.EnableSixteenPlayerLobbyAsync();

        SixteenPlayerLobbyButton.IsEnabled = true;
        SixteenPlayerLobbyButton.Content = enabled
            ? "16 player lobbies enabled"
            : "enable 16 player lobbies";
    ...
    private void Disable_Click(object sender, RoutedEventArgs e)
    {
        ...
        SixteenPlayerLobbyButton.Visibility = Visibility.Visible;
        SixteenPlayerLobbyButton.Content = "enable 16 player lobbies";
    ...
    private void SetStatus(string status)
    {
        ...
        if (SixteenPlayerLobbyButton != null &&
            (status == "Not attached" ||
             status.StartsWith("16 Player Lobby failed", StringComparison.Ordinal)))
        {
